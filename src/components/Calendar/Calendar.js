      ...
      <ul className="calendar-list">
          ...
          <article className="launches">
            ...
            <div className="launches-content">
              <h2 className="launches-title">
                <a href="https://www.space.com/3590-spacex-falcon-1-rocket-fails-reach-orbit.html">DemoSat</a>
              </h2>
              <a href="./details.html" className="button launches-details">
                Подробнее
              </a>
        ...
        <li className="calendar-item">
          <article className="launches">
            ...
            <div className="launches-content">
              <h2 className="launches-title">
                <a href="http://www.spacex.com/news/2013/02/11/falcon-1-flight-3-mission-summary">Trailblazer</a>
              </h2>
              <a href="./details.html" className="button launches-details">
                Подробнее
              </a>
